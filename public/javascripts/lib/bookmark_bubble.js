 ...
 * @private
 */
google.bookmarkbubble.Bubble.prototype.MOBILE_SAFARI_USERAGENT_REGEX_ = /iPhone|iPod|iPad|Android/;
...
{
   var groups = this.IOS_VERSION_USERAGENT_REGEX_.exec(window.navigator.userAgent) || [];
   groups.shift();
...
google.bookmarkbubble.Bubble.prototype.setPosition = function()
{
   ...
   this.element_.style.WebkitTransform = 'translate3d(0,' + this.getVisibleYPosition_() + 'px,0)';
};
...
google.bookmarkbubble.Bubble.prototype.build_ = function()
{
   ...
   bubbleInner.style.background = '#cddcf3 -webkit-gradient(linear, ' + 'left bottom, left top, ' + isIpad ? 'from(#cddcf3), to(#b3caed)) no-repeat top' : 'from(#b3caed), to(#cddcf3)) no-repeat bottom';
   ...
   if (isAndroid)
   {
      bubbleInner.innerHTML = '<b>Install this web app on your phone:</b> ' + 'Add it as a bookmark then add it to your Home Screen';
   }
   else
   {
   ...
   close.style.background = 'url(' + this.IMAGE_CLOSE_DATA_URL_ + ') no-repeat';
