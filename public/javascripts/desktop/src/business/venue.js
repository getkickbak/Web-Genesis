$(document).ready($(function() {
	...
	function set_coordinates() {
		...
		if (country.val().length == 0)
			return	
		realAddress = address.val() + "," + city.val() + "," + state.val() + "," + country.val()
		geocoder.geocode({
			'address' : realAddress
	...
	$("#venue_address").focusout(set_coordinates);
	$("#venue_city").focusout(set_coordinates);
	$("#venue_state").focusout(set_coordinates);
	$("#venue_country").focusout(set_coordinates);
}))