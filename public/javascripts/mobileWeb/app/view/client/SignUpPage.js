      ...
      Ext.merge(config,
      {
         ...
         }),
         {
            ...
            items : [
            {
               ...
               name : 'facebook',
               label : '<img src="' + //
               KickBak.constants.resourceSite + 'resources/images/' + KickBak.constants.themeName + 'facebook_icon.png" ' + //
            ...
            },
            {
               ...
               name : 'twitter',
               label : '<img src="' + //
               KickBak.constants.resourceSite + 'resources/images/' + KickBak.constants.themeName + 'twitter_icon.png" ' + //
