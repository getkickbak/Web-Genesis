Ext.define('Genesis.controller.Redemptions',
{
   ...
   config :
   {
      ...
      refs :
      {
         ...
         redemptions :
         {
            selector : 'redemptionsserverview',
            autoCreate : true,
            xtype : 'redemptionsserverview'
         },
         redemptionsList : 'redemptionsserverview list[tag=redemptionsList]',
         redemptionsPts : 'redemptionsserverview component[tag=points]',
         redemptionsPtsEarnPanel : 'redemptionsserverview dataview[tag=ptsEarnPanel]'
      },
      control :
      {
         redemptions :
   ...
   init : function()
   {
      ...
      console.log("RedemptionsServer Init");
   },
   // --------------------------------------------------------------------------
   // Redemptions Page
   // --------------------------------------------------------------------------
