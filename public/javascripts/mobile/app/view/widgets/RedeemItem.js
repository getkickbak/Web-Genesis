      ...
      },
      {
            ...
            // @formatter:on
         {
            getPhoto : function(values)
            {
               ...
               var photo = Genesis.view.widgets.RedeemItem.getPhoto(values['type']) || values['photo']['thumbnail' + os + 'large'];
      ...
      },
      {
            ...
            // @formatter:on
         {
            ...
            getPhoto : function(values)
            {
               ...
               return values.getMerchant().get('photo')['thumbnail' + os + 'medium'].url;
            },
