 ...
 */
JFFileTransfer.prototype.upload = function(filePath, server, successCallback, errorCallback, options) {
	if(!options.params) {
		options.params = {};
	}
	...
	if (typeof successCallback != "function") {
      console.log("JFFileTransfer Error: successCallback is not a function");
      return;
   }
   ...
   if (errorCallback && (typeof errorCallback != "function")) {
      console.log("JFFileTransfer Error: errorCallback is not a function");
      return;
   }
...
JFFileTransfer.prototype._castUploadResult = function(pluginResult) {
...
JFFileTransfer.prototype._updateProgress = function(pluginResult) {
