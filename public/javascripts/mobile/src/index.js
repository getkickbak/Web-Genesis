...
Ext.setup(
{
    ...
    onReady: function()
    {
        ...
        sink.Main.init();
        console.log("Start Orientation : ", nativeAppOrientation + " Start Window Width=" + window.innerWidth + " Start Window Height=" + window.innerHeight);
        document.addEventListener('orientationchange', function(e)
        {
            ...
            if (nativeAppOrientation != Ext.getOrientation())
            {
                ...
                console.log("-Width=" + width + " -Height=" + height + " -Orientation change to: " + nativeAppOrientation);
                sink.Main.ui.setOrientation(nativeAppOrientation,width,height);
                sink.Main.ui.doLayout();
            }
        });
    }
});
