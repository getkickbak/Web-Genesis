...
=begin
    ...
    merchants.each do |merchant|
      ...
      trans_amount = EarnRewardRecord.sum(:amount, EarnRewardRecord.merchant.id => merchant.id, :challenge_id => 0, :created_ts.gte => (beginning_of_month..end_of_month))
      trans_fee = TransactionRecord.sum(:fee, :type => :earn, :created_ts.gte => (beginning_of_month..end_of_month))
